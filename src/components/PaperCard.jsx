...
export default function PaperCard({ paper, onEdit, onDelete, onAISummary }) {
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-3 shrink-0">
          ...
          <div className="flex flex-col gap-1.5 opacity-0 group-hover:opacity-100 transition">
            <button
              onClick={onAISummary}
              className="text-xs text-purple-400 hover:text-purple-300 px-2 py-1 rounded bg-purple-900/20 hover:bg-purple-900/40 transition whitespace-nowrap"
            >
              ✨ AI Summary
            </button>
            <button
